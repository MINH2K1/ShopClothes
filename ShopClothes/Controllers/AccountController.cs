...
namespace ShopClothes.WebApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        //            userId = user.Id, code = encodedCode }, protocol: Request.Scheme);
